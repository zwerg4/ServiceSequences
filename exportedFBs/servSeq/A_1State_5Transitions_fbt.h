...
class FORTE_servSeq__A_1State_5Transitions final : public CBasicFB {
  DECLARE_FIRMWARE_FB(FORTE_servSeq__A_1State_5Transitions)
  ...
  public:
    FORTE_servSeq__A_1State_5Transitions(CStringDictionary::TStringId paInstanceNameId, forte::core::CFBContainer &paContainer);
