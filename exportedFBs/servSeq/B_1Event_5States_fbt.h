...
class FORTE_servSeq__B_1Event_5States final : public CBasicFB {
  DECLARE_FIRMWARE_FB(FORTE_servSeq__B_1Event_5States)
  ...
  public:
    FORTE_servSeq__B_1Event_5States(CStringDictionary::TStringId paInstanceNameId, forte::core::CFBContainer &paContainer);
