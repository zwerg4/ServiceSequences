...
class FORTE_servSeq__C_1Event_5States_NoConitions_Unreachable final : public CBasicFB {
  DECLARE_FIRMWARE_FB(FORTE_servSeq__C_1Event_5States_NoConitions_Unreachable)
  ...
  public:
    FORTE_servSeq__C_1Event_5States_NoConitions_Unreachable(CStringDictionary::TStringId paInstanceNameId, forte::core::CFBContainer &paContainer);
