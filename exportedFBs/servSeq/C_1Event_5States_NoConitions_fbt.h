...
class FORTE_servSeq__C_1Event_5States_NoConitions final : public CBasicFB {
  DECLARE_FIRMWARE_FB(FORTE_servSeq__C_1Event_5States_NoConitions)
  ...
  public:
    FORTE_servSeq__C_1Event_5States_NoConitions(CStringDictionary::TStringId paInstanceNameId, forte::core::CFBContainer &paContainer);
