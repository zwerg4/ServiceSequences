...
class FORTE_servSeq__D_5States_1Algo_Refactored2 final : public CBasicFB {
  DECLARE_FIRMWARE_FB(FORTE_servSeq__D_5States_1Algo_Refactored2)
  ...
  public:
    FORTE_servSeq__D_5States_1Algo_Refactored2(CStringDictionary::TStringId paInstanceNameId, forte::core::CFBContainer &paContainer);
