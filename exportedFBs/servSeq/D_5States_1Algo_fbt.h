...
class FORTE_servSeq__D_5States_1Algo final : public CBasicFB {
  DECLARE_FIRMWARE_FB(FORTE_servSeq__D_5States_1Algo)
  ...
  public:
    FORTE_servSeq__D_5States_1Algo(CStringDictionary::TStringId paInstanceNameId, forte::core::CFBContainer &paContainer);
