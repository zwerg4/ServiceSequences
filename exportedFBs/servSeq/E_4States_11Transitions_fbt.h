...
class FORTE_servSeq__E_4States_11Transitions final : public CBasicFB {
  DECLARE_FIRMWARE_FB(FORTE_servSeq__E_4States_11Transitions)
  ...
  private:
    ...
    static const TEventID scmEventResetID = 4;
  ...
  public:
    FORTE_servSeq__E_4States_11Transitions(CStringDictionary::TStringId paInstanceNameId, forte::core::CFBContainer &paContainer);
    ...
    void evt_Reset(CIEC_STRING &paOutputString) {
