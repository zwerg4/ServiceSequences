...
class FORTE_servSeq__F_2States_2Algo2 final : public CBasicFB {
  DECLARE_FIRMWARE_FB(FORTE_servSeq__F_2States_2Algo2)
  ...
  public:
    FORTE_servSeq__F_2States_2Algo2(CStringDictionary::TStringId paInstanceNameId, forte::core::CFBContainer &paContainer);
