...
class FORTE_servSeq__G_10Events_5Unused final : public CBasicFB {
  DECLARE_FIRMWARE_FB(FORTE_servSeq__G_10Events_5Unused)
  ...
  public:
    FORTE_servSeq__G_10Events_5Unused(CStringDictionary::TStringId paInstanceNameId, forte::core::CFBContainer &paContainer);
    ...
    void evt_EI7(CIEC_STRING &paOutputString) {
      executeEvent(scmEventEI7ID, nullptr);
      paOutputString = var_OutputString;
    }

    void evt_EI8(CIEC_STRING &paOutputString) {
      executeEvent(scmEventEI8ID, nullptr);
      paOutputString = var_OutputString;
    }

    void evt_EI9(CIEC_STRING &paOutputString) {
      executeEvent(scmEventEI9ID, nullptr);
      paOutputString = var_OutputString;
    }

    void evt_EI10(CIEC_STRING &paOutputString) {
